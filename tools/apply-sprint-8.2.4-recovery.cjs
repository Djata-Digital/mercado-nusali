...
console.log('OK src/components/AddressesView.tsx (preservado da aplicação parcial)');
console.log('OK apps/api/src/modules/shipping-quotes/shipping-quotes.service.ts (preservado da aplicação parcial)');
